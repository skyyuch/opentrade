...
export default tseslint.config(
  ...
  // of file names (per Next 16 file-system routing). next-intl's request
  // resolver and the framework proxy also expect default exports.
  // These are framework contracts, not opinions; the rule must yield.
  {
    files: [
      ...
      'apps/{web,console}/src/proxy.{ts,tsx}',
