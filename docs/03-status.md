...
進度：~70%（Block 1-5 / 7 完成；Block 6 待開始）
...
- **Phase 1 MVP-A Block 6**: merchant console basics（Privy 登入 + claim broker page + 看評論）
- **Phase 1 MVP-A Block 7**: SFC broker seed data（爬取 + 匯入腳本）
...
1. **Block 6: merchant console basics** — Privy 登入 + claim broker page + 看評論
2. **Block 7: SFC broker seed data** — 爬取 + 匯入腳本
