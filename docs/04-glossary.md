...
| 金商         | Bullion Dealer               | 香港貴金屬（黃金 / 白銀）交易商；第 4 類被評對象，沿用 `Broker` 加 `category=BULLION`（ADR-0045，名冊來源見 ADR-0050） |
...
| HKGX         | Hong Kong Gold Exchange                | 香港黃金交易所，金商行員名冊的權威來源（ADR-0045 / ADR-0050），schema 內 `Regulator.HK_HKGX`；2025-01-01 起接替 CGSE  |
| CGSE         | Chinese Gold & Silver Exchange Society | 香港金銀業貿易場，1910 年成立的自律性貴金屬交易所；HKGX 的前身，2024-12-31 完成歷史使命，業務由 HKGX 接替（ADR-0050） |
