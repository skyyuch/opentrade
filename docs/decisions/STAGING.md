...
| ~~S5~~  | ~~ADR-0034~~ | ~~Content moderation: hate speech filter + label-not-delete two-layer~~ | ~~Promoted early as pre-Phase 2 launch hardening (owner-approved 2026-06-05)~~      | → Published: [ADR-0034](./0034-content-moderation.md) (layer 1; label layer deferred) | ~~Done~~                                 |
...
5. ~~**Pre-launch hardening not yet hot**. S5 (moderation) is fine to write reactively to the first real incident.~~ Done: promoted early as pre-Phase 2 launch hardening (owner-approved) → published as [ADR-0034](./0034-content-moderation.md). Layer 1 (pre-publication content-neutral gate + admin wordlist + audit) shipped; layer 2 (post-publication label-not-delete) deferred within the same theme.
