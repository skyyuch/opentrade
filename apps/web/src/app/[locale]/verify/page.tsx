 ...
 *
 * 3-step wizard: left progress tracker + right content area.
 * Per ADR-0022: raw account data never enters our DB — the server only
 * relays the file to IPFS, and only the commitment hash + IPFS CID are
 * persisted.
 *
 * Visual: Google-designed dark crypto layout with atmospheric glows
 * (#00FF88 + blue-600), matching the broader OpenTrade dark theme.
 */
...
const VerifyPage = async ({ params }: Props): Promise<ReactNode> => {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <main className="container relative z-10 mx-auto px-4 py-12 md:py-16 lg:px-10">
        {/* Header */}
        <header className="mb-12 border-b border-white/10 pb-8">
          <div className="mb-4 flex items-center gap-3">
            <div className="rounded-xl border border-[#00FF88]/20 bg-[#00FF88]/10 p-2.5 text-[#00FF88]">
              <Shield size={24} />
            </div>
