/**
 * `apps/console` Tailwind config — extends the shared preset from
 ...
 * and re-export through the preset. The console-specific dark default
 * is configured in `src/components/providers/ThemeProvider.tsx` (via
 * `next-themes`), not here — Tailwind itself stays theme-agnostic.
 */
