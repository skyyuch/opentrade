...
```
Frontend:     Next.js 16 + React 19 + TypeScript + Tailwind + shadcn/ui + next-intl (zh-Hant / zh-Hans / en)
...
├── apps/
│   ├── web/                   # 散戶用戶端 Next.js 16 (Phase 0+ — i18n shell + /status 已上線，light default)
│   ├── console/               # 商戶後台 Next.js 16 (Phase 0+ — dashboard 殼已上線，dark default，robots disallow)
